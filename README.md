...
PlaneCode 2.3.1 adds SetLang and portable `.SPL` SetPlan files while preserving the strict separation of PLang, SetData and SetRender.

- Integration canon: `docs/PLANE_CODE_2.3.1.md`
