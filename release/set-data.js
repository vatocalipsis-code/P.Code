...
"Операции в работе заголовок":{SourceText:"Операции в работе"},"В обработке иконка":{SourcePicture:"../plans/example render.assets/processing-sync.png"},"В обработке название":{SourceText:"В обработке"},"В обработке количество":{SourceText:"8"},
"Нам должны название":{SourceText:"Нам должны"},"Нам должны сумма":{SourceText:"312 400.00"},"Нам должны валюта":{SourceText:"USD"},"Мы должны название":{SourceText:"Мы должны"},"Мы должны сумма":{SourceText:"87 200.00"},"Мы должны валюта":{SourceText:"USD"}
};
